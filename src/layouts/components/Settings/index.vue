...
const { layoutMode, showTagsView, showLogo, fixedHeader, showNotify, showThemeSwitch, showScreenfull, cacheTagsView, showGreyMode, showColorWeakness } = storeToRefs(settingsStore)
