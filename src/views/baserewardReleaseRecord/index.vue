...
const searchData = reactive({
  ...
  releaseTime_begin: '',
  releaseTime_end: '',
  type: 'HyperAGI_BaseReward_Release',
  selectRelease: null,
})
...
async function handleRelease() {
  ...
  const HyperAGI_BaseReward_Release = await buildContract(blockchainId, 'HyperAGI_BaseReward_Release')

  try {
    handleReleaseLoading.value = true
    await (await HyperAGI_BaseReward_Release.release(releaseTimes)).wait()
